...
export default function ContactPage() {
  return (
    <>
      ...
      />
      <section className="container-px grid gap-8 py-14 lg:grid-cols-[0.75fr_1fr]">
        <div className="rounded-[8px] bg-[#171211] p-8 text-white">
          <h2 className="text-4xl font-semibold">Studio details</h2>
          <div className="mt-8 grid gap-5 text-[#d8ccc4]">
            <p className="flex items-center gap-3">
              <Mail className="h-5 w-5 text-[#f6df9e]" />
              hello@nailsxtaran.example
            </p>
            <p className="flex items-center gap-3">
              <Phone className="h-5 w-5 text-[#f6df9e]" />
              +1 555 014 8821
            </p>
            <p className="flex items-center gap-3">
              <MapPin className="h-5 w-5 text-[#f6df9e]" />
              Online studio and private training
            </p>
          </div>
        </div>
        <form className="grid gap-4 rounded-[8px] border border-[#eadfd7] bg-white p-6">
