...
export default function LoginPage() {
  return (
    <section className="container-px grid min-h-[70vh] place-items-center bg-[#fff7ef] py-12 md:py-14">
      <div className="grid w-full max-w-4xl overflow-hidden rounded-[8px] border border-[#eadfd7] bg-white shadow-sm lg:grid-cols-2">
        <div className="bg-[#171211] p-5 text-white sm:p-8 md:p-10">
        ...
        <form className="grid gap-4 p-5 sm:p-8 md:p-10">
