...
export default function TrainingCoursesPage() {
  return (
    <>
      ...
      />
      <section className="container-px grid gap-8 py-14 lg:grid-cols-[0.8fr_1fr]">
        <div className="rounded-[8px] bg-[#171211] p-8 text-white md:p-10">
          ...
          <Button className="mt-7" variant="gold" size="lg">
            Reserve a seat
          </Button>
        </div>
          ...
          {courses.map((course, index) => (
            ...
            >
              ...
              <div className="mt-4 flex items-center gap-2 text-sm font-semibold">
                <CheckCircle2 className="h-5 w-5 text-[#b9914f]" />
